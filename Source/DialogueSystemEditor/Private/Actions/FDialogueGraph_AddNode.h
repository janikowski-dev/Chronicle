...
struct FDialogueGraph_AddNode : FEdGraphSchemaAction
{
	TSubclassOf<UEdGraphNode> NodeClass;

	explicit FDialogueGraph_AddNode(const TSubclassOf<UEdGraphNode> InNodeClass) : NodeClass(InNodeClass)
	{
	}

	explicit FDialogueGraph_AddNode(
