#include "UDialogueNodeGraphSchema.h"

#include "ToolMenus.h"
#include "ToolMenuSection.h"
#include "Actions/FDialogueNodeGraph_AddNode.h"
#include "Actions/FDialogueNodeGraph_AddOutputNode.h"
...
void UDialogueNodeGraphSchema::CreateDefaultNodesForGraph(UEdGraph& Graph) const
{
...
const FPinConnectionResponse UDialogueNodeGraphSchema::CanCreateConnection(
	const UEdGraphPin* A,
	const UEdGraphPin* B
) const
{
